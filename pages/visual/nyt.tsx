...
import {Page, Card, P, ProjectImage} from '@alt/components'
  ...
  >{() =>
    <>
      <Card level={2} middleStacked>
        <ProjectHeader url="https://markets.on.nytimes.com" subhead="MARKETS RESEARCH &mdash; WALL ST ON DEMAND" logo="/nyt/logo.png" >
          <P large>
        ...
        <Block layout={Layouts.Left}>
          ...
          <Block image="/nyt/nyt2.png" layout={Layouts.Right}>
          <P>
          ...
          <Block image="/nyt/nyt3.png" layout={Layouts.Left}>
          <P>
          ...
          <Block image="/nyt/nyt4.png" layout={Layouts.Right}>
          <P>
